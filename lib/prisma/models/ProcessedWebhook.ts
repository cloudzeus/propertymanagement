...
// @ts-nocheck 
/*
 * This file exports the `ProcessedWebhook` model and its related types.
 *
...
export type GetProcessedWebhookAggregateType<T extends ProcessedWebhookAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateProcessedWebhook[P]>
    : Prisma.GetScalarType<T[P], AggregateProcessedWebhook[P]>
}
...
export type GetProcessedWebhookGroupByPayload<T extends ProcessedWebhookGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ProcessedWebhookGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ProcessedWebhookGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ProcessedWebhookGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ProcessedWebhookGroupByOutputType[P]>
      }
    >
  >
...
export type ProcessedWebhookWhereInput = {
  ...
  createdAt?: Prisma.DateTimeFilter<"ProcessedWebhook"> | Date | string
}
...
export type ProcessedWebhookScalarWhereWithAggregatesInput = {
  ...
  createdAt?: Prisma.DateTimeWithAggregatesFilter<"ProcessedWebhook"> | Date | string
}
...
export type ProcessedWebhookOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "source" | "createdAt", ExtArgs["result"]["processedWebhook"]>
...
export type ProcessedWebhookCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface ProcessedWebhookDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends ProcessedWebhookCountArgs>(
    args?: Prisma.Subset<T, ProcessedWebhookCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ProcessedWebhookCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, ProcessedWebhookGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetProcessedWebhookGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
...
export interface ProcessedWebhookFieldRefs {
  ...
  readonly createdAt: Prisma.FieldRef<"ProcessedWebhook", 'DateTime'>
}
