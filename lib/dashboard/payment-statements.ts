...
// Per-unit grouping lives in a db-free module so the client `PaymentsTable` can
// import it (a value import here would drag `@/lib/db` into the client bundle).
export { groupRowsByUnit, type PaymentRowLike, type UnitPaymentRow } from "./payment-grouping";
