...
7. **Συνεργάτες → Κατάλογος υπηρεσιών**: τι «ανοίγετε» στους συνεργάτες. Ο βασικός κατάλογος (45 υπηρεσίες σε 11 κατηγορίες) φορτώνεται με `npx tsx --env-file=.env prisma/seed-service-catalog.ts` — ασφαλές να ξανατρέξει· προσθέστε/αλλάξτε ελεύθερα από τη σελίδα.
