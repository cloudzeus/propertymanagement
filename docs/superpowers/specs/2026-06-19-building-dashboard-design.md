...
4. **Ημερολόγιο** — RecurringTask + actions + panel. **Outlook-style με 3 προβολές:
   Ημερήσια / Εβδομαδιαία / Μηνιαία** (toggle), εμφάνιση επαναλαμβανόμενων εργασιών ως
   events στις σωστές ημερομηνίες/ώρες· μηνιαία = grid, εβδομαδιαία/ημερήσια = time grid.
