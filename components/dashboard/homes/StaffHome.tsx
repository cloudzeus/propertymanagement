...
/**
 * Employee (staff) dashboard content, scoped to `userId` + `companyId`.
 * Rendered by the real /staff page and by the read-only role preview.
 */
export async function StaffHome({ userId, companyId }: { userId: string; companyId: string | undefined }) {
