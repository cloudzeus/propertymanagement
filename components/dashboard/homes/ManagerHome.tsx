...
/**
 * Manager (company) dashboard content, scoped to `companyId`.
 * Rendered by the real /manager page and by the read-only role preview.
 */
export async function ManagerHome({ companyId }: { companyId: string | undefined }) {
