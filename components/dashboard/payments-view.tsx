import { type AllocRow, groupAllocationsByMonth } from "@/lib/dashboard/alloc-view";
...
/**
 * Shared payments UI for owner + resident portals: stat tiles (owed / total)
 * followed by per-month collapsible sections with MoneyRow + receipt links.
 * Callers supply pre-mapped AllocRow[]; grouping happens here.
 */
export function PaymentsView({ rows, title = "Πληρωμές" }: { rows: AllocRow[]; title?: string }) {
